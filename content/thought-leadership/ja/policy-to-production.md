...
- [インド半導体ミッション（ISM）2.0](/ja/resources/thought-leadership/semiconductor-renaissance) の下での新しい設備および材料支援。
...
半導体製造は共同作業です。タタのドレラ（Dholera）ファブ単体だけでも、将来的には毎年数千トンの化学物質、ガス、基板を消費するため、超高純度材料のジャストインタイム配送を確実にするには、半径30分以内にサプライヤー群を配置する必要があります。この共同生産戦略は、サプライチェーンの強靭性に焦点を当てた、より広範な [日印製造業パートナーシップ](/ja/resources/blog/india-japan-manufacturing-partnership) と整合しています。
