...
export function EventTicker() {
  ...
  const tickerContent = (
    <>
      ...
      <span className="font-bold text-xs md:text-sm">Upcoming Event:</span>
      <span className="mx-1 md:mx-2 text-xs md:text-sm">India-Japan Manufacturing Collaboration 2026</span>
      <span className="mx-0.5 md:mx-1 text-xs md:text-sm">—</span>
      <span className="text-white/90 mr-1 md:mr-2 text-xs md:text-sm">July 3, 2026 · Ginza, Tokyo</span>
      <span className="inline-flex items-center px-2 md:px-3 py-0.5 md:py-1 bg-white text-jibb-indigo rounded-full font-bold text-[10px] md:text-xs hover:bg-white/90 transition-all hover:scale-105 shadow-sm mx-1 md:mx-2">Register Now →</span>
      </Link>
