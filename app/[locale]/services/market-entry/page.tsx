...
import { MapPin, ArrowLeft, ArrowRight, ShieldCheck, Compass, Lightbulb, GraduationCap } from "lucide-react";
...
export default async function MarketEntryPage({
  ...
  const steps = [
    {
      num: "01",
      title: t("servicesPage.marketEntry.step1Title"),
      desc: t("servicesPage.marketEntry.step1Desc"),
    },
    {
      num: "02",
      title: t("servicesPage.marketEntry.step2Title"),
      desc: t("servicesPage.marketEntry.step2Desc"),
    },
    {
      num: "03",
      title: t("servicesPage.marketEntry.step3Title"),
      desc: t("servicesPage.marketEntry.step3Desc"),
    },
  ];
          ...
          <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-start">
            <div className="md:col-span-8 space-y-6 text-left">
              ...
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                {t("servicesPage.marketEntry.para1")}
              </p>
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                {t("servicesPage.marketEntry.para2")}
              </p>
            </div>
            ...
            <div className="md:col-span-4 flex justify-center">
              <div className="relative w-full max-w-xs rounded-2xl p-6 bg-card border border-border shadow-jibb flex flex-col gap-4 text-left overflow-hidden">
                ...
                <h3 className="text-xs font-bold text-foreground tracking-tight uppercase">Key Focus Sectors</h3>
                <ul className="space-y-2 text-xs text-muted-foreground">
                  <li className="flex items-center gap-1.5"><span className="text-jibb-orange font-bold">•</span> Semiconductors</li>
                  <li className="flex items-center gap-1.5"><span className="text-jibb-orange font-bold">•</span> Advanced Manufacturing</li>
                  <li className="flex items-center gap-1.5"><span className="text-jibb-orange font-bold">•</span> EV Systems &amp; Batteries</li>
                  <li className="flex items-center gap-1.5"><span className="text-jibb-orange font-bold">•</span> Clean Energy Incentives</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-jibb-gradient text-white relative overflow-hidden">
        ...
        <div className="section-container relative z-10 text-center max-w-3xl space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold">
            Looking to Establish Your Office?
          </h2>
          <p className="text-sm md:text-base text-white/70 leading-relaxed max-w-xl mx-auto">
            Become a corporate member to access pre-vetted physical office spots in Noida and Tokyo, and direct connections to regulatory facilitators.
          </p>
