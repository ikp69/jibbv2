...
import { Handshake, ArrowLeft, ArrowRight, ShieldCheck, Compass, Lightbulb, Trophy } from "lucide-react";
...
export default async function PartnershipFacilitationPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const steps = [
    {
      num: "01",
      title: t("servicesPage.partnership.step1Title"),
      desc: t("servicesPage.partnership.step1Desc"),
    },
    {
      num: "02",
      title: t("servicesPage.partnership.step2Title"),
      desc: t("servicesPage.partnership.step2Desc"),
    },
    {
      num: "03",
      title: t("servicesPage.partnership.step3Title"),
      desc: t("servicesPage.partnership.step3Desc"),
    },
  ];
      ...
      <PageHero className="py-20 lg:py-28">
        <div className="section-container relative z-10 text-left max-w-4xl space-y-6">
          ...
          <p className="text-sm md:text-base text-white/80 max-w-2xl leading-relaxed">
            {t("servicesPage.partnership.subtitle")}
          </p>
        </div>
      </PageHero>
          ...
          <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-start">
            <div className="md:col-span-8 space-y-6 text-left">
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">
                Connecting Precision with Speed
              </h2>
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                {t("servicesPage.partnership.para1")}
              </p>
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                {t("servicesPage.partnership.para2")}
              </p>
            </div>
            ...
            <div className="md:col-span-4 flex justify-center">
              <div className="relative w-full max-w-xs rounded-2xl p-6 bg-card border border-border shadow-jibb flex flex-col gap-4 text-left overflow-hidden">
                ...
                <h3 className="text-xs font-bold text-foreground tracking-tight uppercase">Bilateral Matchmaking</h3>
                <ul className="space-y-2 text-xs text-muted-foreground">
                  <li className="flex items-center gap-1.5"><span className="text-jibb-orange font-bold">•</span> Verified Directory Listings</li>
                  <li className="flex items-center gap-1.5"><span className="text-jibb-orange font-bold">•</span> Technical Standards Vetting</li>
                  <li className="flex items-center gap-1.5"><span className="text-jibb-orange font-bold">•</span> Joint Venture Structuring</li>
                  <li className="flex items-center gap-1.5"><span className="text-jibb-orange font-bold">•</span> Shared R&amp;D Agreements</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-jibb-gradient text-white relative overflow-hidden">
        ...
        <div className="section-container relative z-10 text-center max-w-3xl space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold">
            Accelerate Bilateral Co-Innovation
          </h2>
          <p className="text-sm md:text-base text-white/70 leading-relaxed max-w-xl mx-auto">
            Become a corporate member today to get pre-screened introductions, pitch to Japanese tech giants, and unlock dedicated incubation services.
          </p>
